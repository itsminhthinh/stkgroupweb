...
<head>
	...
	<link rel="stylesheet" href="xulydonhang.css">
	  ...
	  <div class="collapse navbar-collapse" id="navbarNav">
	    <ul class="navbar-nav">
	      <li class="nav-item active">
	        <a class="nav-link btn btn-warning mr-4" href="xulydonhang.php">Đơn hàng <span class="sr-only">(current)</span></a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link btn btn-primary mr-4" href="xulydanhmuc.php">Danh mục</a>
	      </li>
	         <li class="nav-item">
	        <a class="nav-link btn btn-info mr-4" href="xulydanhmucbaiviet.php">Danh mục Bài viết</a>
	      </li>
	         <li class="nav-item">
	        <a class="nav-link btn btn-success mr-4" href="xulybaiviet.php">Bài viết</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link btn btn-danger mr-4" href="xulysanpham.php">Sản phẩm</a>
	      </li>
	       <li class="nav-item">
	         <a class="nav-link btn btn-light mr-4" href="xulykhachhang.php">Khách hàng</a>
	      </li>
	...
	<div class="container-fluid">
		<div class="column"style="margin-left:300px;">
			...
			<form action="" method="POST">
				...
				<input type="submit" value="Cập nhật đơn hàng" name="capnhatdonhang" class="btn btn-success"style="margin-bottom:30px">
			</form>
				</div>  
			<?php
			}else{
				...
				?> 
			<div class="col-md-5">
				<h4 style="width:890px">Liệt kê đơn hàng</h4>
				<?php
				...
				?> 
				<table class="table table-bordered table table-dark table-striped"style="width:890px">
					<tr>
						<th>Thứ tự</th>
						<th>Mã hàng</th>
					...
					<tr>
						...
						<td><a class="text-danger"href="?xoadonhang=<?php echo $row_donhang['mahang'] ?>">Xóa</a> ||
						 <a class="text-success" href="?quanly=xemdonhang&mahang=<?php echo $row_donhang['mahang'] ?>">Xem </a></td>
					</tr>
					 <?php
					} 
					?> 
