	...
	<div class="container">
		...
		<?php
			...
			<div class="col-md-8"style="width:500px">
				<h4 style="width:890px">Liệt kê sản phẩm</h4>
				<?php
				...
				<table class="table table-bordered table table-dark table-striped " style="width:890px">
					...
					<tr>
						...
						<td><a class="text-danger"href="?xoa=<?php echo $row_sp['sanpham_id'] ?>">Xóa</a> || <a class="text-success" href="xulysanpham.php?quanly=capnhat&capnhat_id=<?php echo $row_sp['sanpham_id'] ?>">Cập nhật</a></td>
					</tr>
				<?php
					} 
					?> 
