...
<head>
	...
	<link rel="stylesheet" href="xulybaiviet.css">
			...
			<div class="col-md-8">
				...
				<table class="table table-bordered table table-dark table-striped " >
					...
					<tr>
						...
						<td><a class="text-danger" href="?xoa=<?php echo $row_bv['baiviet_id'] ?>">Xóa</a> || <a class="text-success" href="xulybaiviet.php?quanly=capnhat&capnhat_id=<?php echo $row_bv['baiviet_id'] ?>">Cập nhật</a></td>
					</tr>
				<?php
					} 
					?> 
