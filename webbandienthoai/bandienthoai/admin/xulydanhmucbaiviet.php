...
<head>
	...
	<link rel="stylesheet" href="xulydanhmucbaiviet.css">
</head>
<body>
			...
			<div class="col-md-8">
				...
				<table class="table table-bordered table table-dark table-striped ">
					...
					<tr>
						...
						<td><a class="text-danger" href="?xoa=<?php echo $row_category['danhmuctin_id'] ?>">Xóa</a> || <a class="text-success" href="?quanly=capnhat&id=<?php echo $row_category['danhmuctin_id'] ?>">Cập nhật</a></td>
					</tr>
					<?php
					} 
					?>
