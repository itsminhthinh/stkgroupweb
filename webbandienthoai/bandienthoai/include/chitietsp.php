...
<!-- page -->
	...
	?>
	<!-- Single Page -->
	<div class="banner-bootom-w3-agileits py-5"style="background-color:khaki">
			...
			<div class="row">
				<div class="col-lg-5 col-md-8 single-right-left ">
					<div class="grid images_3_of_2">
						<div>
							<ul>
								<div  data-thumb="images/<?php echo $row_chitiet['sanpham_image'] ?>" >
									<div class="thumb-image">
										<img src="images/<?php echo $row_chitiet['sanpham_image'] ?>" data-imagezoom="true" style="width:400px;height:400px" alt=""> </div>
								</div>
