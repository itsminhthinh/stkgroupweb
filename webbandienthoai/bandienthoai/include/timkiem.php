...
<!-- top Products -->
	<div class="ads-grid py-sm-5 py-4"style="background-color:khaki">
		<div class="container py-xl-4 py-lg-2"style="background-color:wheat">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-2 mb-3"style="background-color:orange ;margin-left:20px;width:1070px">Từ khóa tìm kiếm : <?php echo $title ?></h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						<!-- first section -->
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4"style="background-color:white">
							<div class="row">
								<?php
