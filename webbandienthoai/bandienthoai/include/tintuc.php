...
<!-- page -->
	...
	<!-- //page -->
<!-- about -->
	<div class="welcome py-sm-5 py-4"  style="background-color:khaki">
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<div class="col-lg-4 welcome-right-top mt-lg-0 mt-sm-5 mt-4">
					<img src="images/<?php echo $row_baiviet['baiviet_image'] ?>" class="img-fluid" alt=" "style="width:350px;height:350px">
				</div>
