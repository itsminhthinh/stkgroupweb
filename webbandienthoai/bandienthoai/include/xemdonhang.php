...
?>
<!-- top Products -->
	<div class="ads-grid py-sm-5 py-4" style="background-color:khaki;">
		<div class="container py-xl-4 py-lg-2"style="background-color:wheat">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3" style="background-color:orange">Xem đơn hàng</h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
				<div class="agileinfo-ads-display col-lg-9"style="background:wheat">
					<div class="wrapper"style="background-color:white">
						<!-- first section -->
						
							<div class="row"style="text-align:center;background-color:wheat">
								<?php
							...
							<div class="col-md-12">
								<p style="background-color:orange;color:black;width:200px margin-left:500px">Chi tiết đơn hàng</p><br>
								<?php
