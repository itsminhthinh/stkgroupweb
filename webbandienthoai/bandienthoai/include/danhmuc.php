...
<!-- top Products -->
	<div class="ads-grid py-sm-5 py-4"style="background-color:khaki;">
		<div class="container py-xl-4 py-lg-2"style="background-color:orange" >
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3"style="border:2px"><?php echo $title ?></h3>
			<!-- //tittle heading -->
			<div class="row"style="background-color:wheat">
				<!-- product left -->
				<div class="agileinfo-ads-display col-lg-9"style="background-color:white;width:1200px">
					<div class="wrapper">
						<!-- first section -->
