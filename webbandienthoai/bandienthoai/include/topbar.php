...
<!-- top-header -->
	<div class="agile-main-top"style="background-color:khaki;">
		<div class="container-fluid">
		
			
					
				</div>
				<div class="col-lg-8 header-right mt-lg-0 mt-2"style="margin-left:600px;padding-top:20px;margin-right:auto;background-color:#b0e0e">
					<!-- header lists -->
					<ul>
						...
						?>
						<li style="background-color:white" class="text-center border-right text-white">
							<a href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>" class="text-black">
						...
						<li class="text-center border-right text-black"style="background-color:white;">
							<a href="#" data-toggle="modal" data-target="#dangnhap" class="text-black">
								<i class="fas fa-sign-in-alt mr-2"></i> Đăng nhập </a>
						</li>
						<li class="text-center text-black" style="background-color:white">
							<a href="#" data-toggle="modal" data-target="#dangky" class="text-black">
								<i class="fas fa-sign-out-alt mr-2"></i>Đăng ký </a>
						</li>
						<li class="logout" style="background-color:white;text-align:center">
							<a href="index.php"id="exit" class="text-black">
	...
	<!-- header-bottom-->
	<div class="header-bot"style="background-color:khaki;">
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.php" class="font-weight-bold ">
							<img src="uploads/logo2.png" alt=" " class="img-fluid">STK SHOP
						</a>
					</h1>
				</div>
				<!-- //logo -->
